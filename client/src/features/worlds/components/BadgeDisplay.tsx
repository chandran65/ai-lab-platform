  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Badges Earned</span>
      </div>
      <motion.div variants={container} initial="hidden" animate="show" className="flex flex-wrap gap-4">
        {filtered.map((badge) => (
          <motion.div key={badge.badge_id} variants={badgeItem} className="relative group">
